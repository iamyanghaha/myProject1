...
var currentTime=new Date().getTime();//获取时间戳
//base64加密开始  
...
/*function dataInit(){
    ...
    AjaxUtil.request({url:path+"/post/User/getuserLogin",params:{},type:'json',callback:function(json){
    	
		if(json.returnCode=="0"){
			$("#showUser").html("操作人："+json.bean.uname);
			//1.初始化Table   
