...
function getDate() {
	var date = new Date();
	var date_in = date.getFullYear() + "年" + (date.getMonth() + 1) + "月" +
		date.getDate() + "日    " + "星期" + "日一二三四五六".charAt(date.getDay()) + "  " + checkTime(date.getHours()) + ":" +
		checkTime(date.getMinutes()) + ":" + checkTime(date.getSeconds());
	document.getElementById("sysdate").innerHTML = date_in;
